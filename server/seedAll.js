...
async function seed() {
  ...
  const allStudents = await all(
    "SELECT id, student_name, roll_number, email FROM students",
  );
  ...
  const communityEntries = [
    [
      ...
      "workshop",
      "Local School NGO",
      "Conducted coding workshop for school students",
      3,
      "2025-06-15",
      "",
      30,
    ...
    [
      ...
      "coding_session",
      "Tech4Good NGO",
      "Python programming bootcamp for underprivileged youth",
      2,
      "2025-07-20",
      "",
      35,
    ...
    [
      ...
      "IoT demo session for rural engineering students",
      3,
      "2025-05-10",
      "",
      25,
    ...
    [
      ids[4],
      "coding_session",
      "CodeReach Foundation",
      "Web development crash course at community college",
      1,
      "2025-08-01",
      "",
      40,
    ...
    [
      ...
      "Electronics recycling awareness drive",
      2,
      "2025-09-12",
      "",
      20,
  ...
  const scopusEntries = [
    ...
    [
      ids[2],
      "IoT-Enabled Smart Campus Framework",
      "journal",
      "Elsevier IoT Journal",
      "2025-07-01",
      1,
      "Dr. Sunita Agarwal",
      "",
  ...
  const projectEntries = [
    [
      ...
      "Industry - TechCorp",
      8,
      "Face recognition based attendance for classrooms",
      "https://github.com/rahul/smart-attendance",
      "",
      "",
      80,
    ],
    [
      ...
      "Real-time water quality monitoring for rural areas",
      "NGO - CleanWater Foundation",
      9,
      "IoT-based water quality measurement and alerting system",
      "https://github.com/sneha/water-quality",
      "",
      "",
      120,
    ],
    [
      ids[5],
      "EduBot - AI Tutor",
      "AI-powered tutoring chatbot for school students",
      "Community - Local School",
      7,
      "NLP chatbot that helps K-12 students with homework",
      "https://github.com/divya/edubot",
      "",
      "",
      100,
    ],
    [
      ...
      "Community - Village Cooperative",
      9,
      "Mobile app connecting farmers to consumers, eliminating middlemen",
      "https://github.com/karthik/farmconnect",
      "",
      "",
      140,
    ],
