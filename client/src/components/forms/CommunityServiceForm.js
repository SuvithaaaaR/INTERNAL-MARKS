  ...
  return (
    <Stack gap="lg">
      <Card shadow="sm" padding="lg" radius="md" withBorder>
        ...
        >
          <Text size="sm">
            <strong>Marks Allocation:</strong> Conducted Workshop/Coding Session
            at School/NGO/Industry: 40 marks per entry. Team of max 3 members.
              ...
              <Stack gap="md">
                <Group grow>
                  <Select
                    ...
                    data={[
                      { value: "workshop", label: "Workshop/Training Program" },
                      { value: "coding_session", label: "Coding Session" },
                      {
                ...
                <Textarea
                  ...
                  placeholder="Topics covered, duration, participants, impact..."
                  rows={3}
                />
                <Group grow>
                  <NumberInput
                    label="Team Size (Max 3)"
                    required
                    value={formData.team_size}
                    onChange={(v) => setFormData({ ...formData, team_size: v })}
                    min={1}
                    max={10}
                  />
                  <TextInput
              ...
              <Paper key={entry.id} p="md" withBorder>
                <Group justify="space-between" align="flex-start">
                  <Stack gap="xs" style={{ flex: 1 }}>
                    ...
                    <Group gap="xl">
                      <Text size="sm">
                        <strong>Type:</strong> {entry.activity_type}
                      </Text>
                      <Text size="sm">
                        <strong>Team:</strong> {entry.team_size} members
                      </Text>
                      <Text size="sm">
                        <strong>Date:</strong> {entry.date_conducted}
                      </Text>
                    </Group>
