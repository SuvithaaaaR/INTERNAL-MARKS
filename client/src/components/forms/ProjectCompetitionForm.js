    ...
    <div>
      <div className="card">
        ...
        >
          ...
          <br />
          • Participated (Top 300 NIRF Institution): 40 marks
          <br />
          • Won/Awarded: 80 marks
          <br />• Industry Project (Level 3-5): 160 marks
        </div>
              ...
              <div key={entry.id} className="entry-card">
                ...
                >
                  <div style={{ flex: 1 }}>
                    ...
                    >
                      <h4 style={{ margin: 0 }}>{entry.competition_name}</h4>
                      <div
                        style={{
                    ...
                    <div className="entry-details">
                      ...
                      {entry.industry_level > 0 && (
                        <div>
                          <strong>Industry Level:</strong>{" "}
                          {entry.industry_level}
                        </div>
                      )}
                      <div>
