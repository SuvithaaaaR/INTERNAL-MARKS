...
const WorkshopForm = ({ studentId, onSuccess, canDelete = true }) => {
  ...
  const fetchEntries = async () => {
    try {
      const r = await getWorkshops(studentId);
      setEntries(r.data);
    } catch (e) {
      console.error(e);
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      notifications.show({
        title: "Success",
        message: "Workshop/Seminar entry added!",
        color: "green",
      });
      setShowForm(false);
      setFormData({
  ...
  return (
    <Stack gap="lg">
      <Card shadow="sm" padding="lg" radius="md" withBorder>
        ...
        >
          <Text size="sm">
            <strong>Marks:</strong> Based on event type, institution NIRF
            ranking, and duration.
          </Text>
        </Alert>
            ...
            <form onSubmit={handleSubmit}>
              <Stack gap="md">
                ...
                <TextInput
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, date_attended: e.target.value })
                  }
                />
                <div>
