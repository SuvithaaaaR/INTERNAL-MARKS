...
const PatentForm = ({ studentId, onSuccess, canDelete = true }) => {
  ...
  const fetchEntries = async () => {
    try {
      const r = await getPatents(studentId);
      setEntries(r.data);
    } catch (e) {
      console.error(e);
    }
    ...
    <Stack gap="lg">
      <Card shadow="sm" padding="lg" radius="md" withBorder>
        <Group justify="space-between" mb="md">
          <Title order={3}>
            Patent Filing & Prototyping (Full FA: 240 marks)
          </Title>
          <Button
        ...
        >
          <Text size="sm">
            <strong>Marks:</strong> Prototype + Patent filing + IPM cell
            publication OR Technology transfer. Full FA component (240 marks
            max).
          </Text>
        </Alert>
              ...
              <Stack gap="md">
                <Group grow>
                  <Select
                    ...
                    onChange={(v) =>
                      setFormData({ ...formData, patent_type: v })
                    }
                    data={[
                ...
                <TextInput
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, patent_title: e.target.value })
                  }
                ...
                <Group>
                  <Switch
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        prototype_developed: e.currentTarget.checked,
                      })
                    }
                  />
                  <Switch
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        technology_transfer: e.currentTarget.checked,
                      })
                    }
                  />
                </Group>
                <div>
                  ...
                  <Text size="xs" c="dimmed" mt={4}>
                    {proofFile
                      ...
                      : "Upload a PDF patent proof document (max 10MB)"}
                  </Text>
                </div>
                ...
                <Group justify="space-between" align="flex-start">
                  <Stack gap="xs" style={{ flex: 1 }}>
                    ...
                    <Group gap="xl">
                      ...
                      <Text size="sm">
                        <strong>Filed:</strong> {entry.filing_date}
                      </Text>
                    </Group>
                    <Group gap="md">
