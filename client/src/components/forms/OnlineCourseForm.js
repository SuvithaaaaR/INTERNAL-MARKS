...
const OnlineCourseForm = ({ studentId, onSuccess, canDelete = true }) => {
  ...
  const fetchEntries = async () => {
    try {
      const r = await getOnlineCourses(studentId);
      setEntries(r.data);
    } catch (e) {
      console.error(e);
    }
  ...
  return (
    <Stack gap="lg">
      <Card shadow="sm" padding="lg" radius="md" withBorder>
        ...
        >
          <Text size="sm">
            <strong>Marks:</strong> Based on course type (NPTEL/Coursera/Udemy
            etc.), duration, and completion.
          </Text>
        </Alert>
              ...
              <Stack gap="md">
                <Group grow>
                  <Select
                    ...
                    onChange={(v) =>
                      setFormData({ ...formData, course_type: v })
                    }
                    data={[
                  ...
                  <NumberInput
                    ...
                    onChange={(v) =>
                      setFormData({ ...formData, duration_weeks: v })
                    }
                    min={1}
                    max={52}
                  />
                ...
                <Group justify="space-between" align="flex-start">
                  <Stack gap="xs" style={{ flex: 1 }}>
                    ...
                    <Group gap="xl">
                      ...
                      <Text size="sm">
                        <strong>Platform:</strong> {entry.platform || "N/A"}
                      </Text>
                      <Text size="sm">
